/****************************************************************************
** Meta object code from reading C++ file 'main_window_class.h'
**
...
#error "The header file 'main_window_class.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 33, 20), // "finishedLoadingFiles"
QT_MOC_LITERAL(4, 54, 27), // "on_pushButtonShowID_clicked"
QT_MOC_LITERAL(5, 82, 34), // "on_commandLinkButtonBrowse_cl..."
QT_MOC_LITERAL(6, 117, 12), // "loadFileList"
QT_MOC_LITERAL(7, 130, 11), // "_text_files"
QT_MOC_LITERAL(8, 142, 14), // "setProgressbar"
QT_MOC_LITERAL(9, 157, 16), // "compeleteLoading"
QT_MOC_LITERAL(10, 174, 33) // "on_pushButtonSecondWindow_cli..."

    },
    "MainWindowClass\0progressChanged\0\0"
...
void MainWindowClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MainWindowClass::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindowClass::progressChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainWindowClass::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindowClass::finishedLoadingFiles)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MainWindowClass::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_MainWindowClass.data,
    qt_meta_data_MainWindowClass,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void MainWindowClass::progressChanged(int _t1)
{
...
// SIGNAL 1
void MainWindowClass::finishedLoadingFiles()
{
